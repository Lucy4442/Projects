...
class ViewController: UIViewController {
    ...
    let region = (center: CLLocationCoordinate2D(latitude: 21.24103994441933, longitude: 72.87149637943766), delta: 0.1)
    ...
    @IBAction func addAnnotations(_ sender: UIButton? = nil) {
        ...
        let annotations: [Annotation] = (0..<10).map { i in
            ...
            annotation.coordinate = CLLocationCoordinate2D(latitude: region.center.latitude + 2*drand48() * region.delta - region.delta / 2, longitude: region.center.longitude + 2*drand48() * region.delta - region.delta / 2)
            return annotation
        }
...
extension ViewController: MKMapViewDelegate {
    ...
    func mapView(_ mapView: MKMapView, didSelect view: MKAnnotationView) {
        ...
        guard let annotation = view.annotation as? MKMarkerAnnotationView else { return }
